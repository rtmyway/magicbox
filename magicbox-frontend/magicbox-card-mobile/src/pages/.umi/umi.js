...
import findRoute, {
  getUrlQuery,
} from '/home/taozhen/repo/git_repo/github/magicbox/magicbox-frontend/magicbox-card-mobile/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path:
        '/home/taozhen/repo/git_repo/github/magicbox/magicbox-frontend/magicbox-card-mobile',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
