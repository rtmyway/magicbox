...
import findRoute, {
  getUrlQuery,
} from '/home/taozhen/repo/git_repo/github/magicbox/magicbox-frontend/magixbox-card-ui/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path:
        '/home/taozhen/repo/git_repo/github/magicbox/magicbox-frontend/magixbox-card-ui',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
